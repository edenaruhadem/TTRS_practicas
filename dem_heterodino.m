...
%% Filtros IF
fpb1=[0 0.04 0.08 0.12 0.16 1]; mask_fpb1=[0 0 1 1 0 0]; L_fpb1=80;     % paso banda orden 80 
hpb1=firpm(L_fpb1,fpb1,mask_fpb1);
filter_xif1=4*filter(hpb1,1,xif1);
fpb2=[0 0.2 0.28 0.32 0.4 1]; mask_fpb2=[0 0 1 1 0 0]; L_fpb2=80;     % paso banda orden 80 
...
bb2 = filter_xif2.*c2;
%% Filtros paso bajo
fpaso_bajo1=[0 0.02 0.1 1]; mask_fpaso_bajo1=[1 1 0 0]; L_paso_bajo1=50;     
h_paso_bajo1=firpm(L_paso_bajo1,fpaso_bajo1,mask_fpaso_bajo1);                           
m_est_fif1=filter(h_paso_bajo1,1,bb1);                           
fpaso_bajo2=[0 0.02 0.3 1]; mask_fpaso_bajo2=[1 1 0 0]; L_paso_bajo2=30;      
